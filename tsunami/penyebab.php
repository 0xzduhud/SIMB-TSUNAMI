...
<head>
  ...
  <title>Waver — Penyebab Tsunami</title>
...
<body>
  ...
  <section class="hero" id="hero">
    <div class="hero-content" data-aos="fade-up" data-aos-duration="1200">
      <h1>Penyebab Terjadinya Tsunami</h1>
      <p>Memahami berbagai faktor yang dapat memicu gelombang tsunami untuk meningkatkan kewaspadaan</p>
    </div>
  </section>
  ...
  <main>
    ...
    <section class="content-container" data-aos="fade-up">
      <h2>Penyebab Utama Tsunami</h2>
      <p>Tsunami dapat dipicu oleh berbagai peristiwa alam yang menyebabkan perpindahan massa air dalam skala besar. Berikut adalah penyebab-penyebab utama terjadinya tsunami:</p>
      
      <!-- Grid 2x2 untuk 4 card penyebab -->
      <div class="causes-grid">
        <!-- Baris 1 - Card 1 & 2 -->
        <div class="cause-card" data-aos="zoom-in" data-aos-delay="100">
          <div class="cause-icon">
            <i class="fas fa-water"></i>
          </div>
          <h3>Gempa Bumi di Bawah Laut</h3>
          <p>Gempa bawah laut terjadi akibat tubrukan lempeng tektonik dan dapat memicu tsunami jika pusat gempa kurang dari 30 km di bawah laut dengan magnitudo yang cukup besar.</p>
        </div>
        
        <div class="cause-card" data-aos="zoom-in" data-aos-delay="200">
          <div class="cause-icon">
            <i class="fas fa-mountain"></i>
          </div>
          <h3>Letusan Gunung Berapi</h3>
          <p>Letusan gunung berapi dapat memicu tsunami jika getarannya cukup kuat, setara dengan gempa bawah laut, atau jika terjadi longsoran material vulkanik ke laut.</p>
        </div>
        
        <!-- Baris 2 - Card 3 & 4 -->
        <div class="cause-card" data-aos="zoom-in" data-aos-delay="300">
          <div class="cause-icon">
            <i class="fas fa-layer-group"></i>
          </div>
          <h3>Longsor di Bawah Laut</h3>
          <p>Longsor bawah laut terjadi akibat gempa tektonik, letusan gunung bawah laut, atau tabrakan lempeng, yang getarannya dapat memicu tsunami dengan menggerakkan massa air.</p>
        </div>
        
        <div class="cause-card" data-aos="zoom-in" data-aos-delay="400">
          <div class="cause-icon">
            <i class="fas fa-meteor"></i>
          </div>
          <h3>Hantaman Meteor</h3>
          <p>Meteor besar dengan diameter lebih dari 1 km dapat menimbulkan bencana dahsyat, efeknya mirip saat benda berat menghantam air, memicu gelombang besar yang merambat.</p>
        </div>
      </div>
    </section>

    <!-- Statistik Penyebab Tsunami -->
    <section class="stats-section" data-aos="fade-up">
      <h2>Distribusi Penyebab Tsunami</h2>
      <div class="stats-grid">
        <div class="stat-card">
          ...
          <div class="stat-label">Gempa Bawah Laut</div>
        </div>
        <div class="stat-card">
          <div class="stat-icon">
            <i class="fas fa-mountain"></i>
          ...
          <div class="stat-label">Letusan Gunung</div>
        </div>
        <div class="stat-card">
          <div class="stat-icon">
            <i class="fas fa-layer-group"></i>
          ...
          <div class="stat-label">Longsor Bawah Laut</div>
        </div>
        <div class="stat-card">
          <div class="stat-icon">
            <i class="fas fa-meteor"></i>
          ...
          <div class="stat-label">Hantaman Meteor</div>
        </div>
      </div>
    </section>
